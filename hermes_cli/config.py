...
DEFAULT_CONFIG = {
    ...
    "delegation": {
        ...
        "max_async_children": 0,  # background=true subagents are disabled by default.
                                  # Set to 1+ to allow that many concurrent async children.
    ...
    "kanban": {
        # Run the dispatcher inside the gateway process. Default is false for
        # Mission Control safety: the dashboard is the status authority, and
        # embedded dispatch/worker spawning must be explicitly enabled in a
        # separate gated lane.
