...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("codex-handoff", "Queue and review manual Codex foreground work packets", "Session",
               aliases=("codex",), args_hint="[list|create|show|claim|return|review|block]",
               subcommands=("list", "create", "show", "claim", "return", "review", "block")),
