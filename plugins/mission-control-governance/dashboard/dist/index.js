(function () {
  ...
  function GovernancePage() {
    ...
    const inertFlags = [
      ...
      "would_execute=" + valueText(workspaceStatus.would_execute, "unknown"),
      "execution_enabled=" + valueText(workspaceStatus.execution_enabled, "unknown"),
      "dispatch_enabled=" + valueText(workspaceStatus.dispatch_enabled, "unknown"),
      "session_send_enabled=" + valueText(workspaceStatus.session_send_enabled, "unknown"),
      "worker_dispatch_enabled=" + valueText(workspaceStatus.worker_dispatch_enabled, "unknown"),
