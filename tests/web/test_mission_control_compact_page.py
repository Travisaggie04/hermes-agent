...
def test_compact_route_has_project_rooms_and_record_draft_controls() -> None:
    ...
    for expected in [
        ...
        "Send to Jenny will ask for a challenge/spec-first reply before any implementation plan.",
        ...
        "Refresh replies",
        "w-full max-w-[100dvw] overflow-x-hidden",
        ...
        "flex w-full min-w-0 max-w-full gap-1.5 overflow-x-auto overscroll-x-contain",
        "min-w-[9.5rem] max-w-[80vw] shrink-0",
