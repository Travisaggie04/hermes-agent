...
def test_compact_route_has_project_rooms_and_record_draft_controls() -> None:
    ...
    for expected in [
        ...
        "overflow-visible xl:grid-cols-[minmax(0,1fr)_22rem] xl:overflow-hidden",
        "min-h-[calc(100dvh-8rem)]",
        "sm:h-[calc(100vh-5rem)] sm:min-h-[34rem]",
        "grid min-w-0 grid-cols-1 gap-1.5 sm:grid-cols-[auto_repeat(5,minmax(0,1fr))]",
        "min-w-0 max-w-full rounded-md",
