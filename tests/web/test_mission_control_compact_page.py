...
def test_compact_route_has_project_rooms_and_record_draft_controls() -> None:
    ...
    for expected in [
        ...
        "Tap Run Jenny once to get a reply for the latest message.",
        ...
        "no production, posting, payment, outreach, or deploy",
        "Jenny memory storage",
        "WORKSPACE_PROFILE_MEMORY_STORAGE_URL",
        "gateway update as a separate explicit lane",
        "Stop before deleting, pruning, moving, or uploading anything",
        "bottom-bar version",
